...
class HParams:
    ...
    logdir = "./logdir_disgust2/"  # log dir where the checkpoints and tensorboard files are saved
    ...
    text2mel_max_iteration = 5000  # max train step = 300k, fine tuning for 100k steps
